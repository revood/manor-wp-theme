...
if ( ! function_exists( 'manor_share_post_links' ) ) :
	...
	function manor_share_post_links() {
		...
		?>
		<a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo esc_url( $permalink ); ?>" class="share fb">
			<span class="screen-reader-text"><?php esc_html_e( 'Share article on Facebook', 'manor' ); ?></span>
		...
		<a href="https://twitter.com/intent/tweet?text=<?php echo rawurlencode( get_the_title() ); ?>&url=<?php echo esc_url( $permalink ); ?>&via=<?php echo esc_attr( get_theme_mod( 'twitter_handle' ) ); ?>" class="share twitter">
			<span class="screen-reader-text"><?php esc_html_e( 'Share article on Twitter', 'manor' ); ?></span>
